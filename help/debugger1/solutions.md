...
La pestaña Analytics proporciona información sobre su implementación de [Analytics](https://experiencecloud.adobe.com/resources/help/en_US/reference/).
...
Utilice la pestaña [Audience Manager](https://experiencecloud.adobe.com/resources/help/en_US/aam/) para ver los detalles de los [eventos](https://experiencecloud.adobe.com/resources/help/en_US/aam/dcs-event-calls.html). Haga clic en la organización para expandirla y mostrar la información.
...
Consulte [Sincronización de ID para transferencias de datos de entrada](https://experiencecloud.adobe.com/resources/help/en_US/aam/c_id_sync_in.html) en la documentación del producto de Audience Manager para obtener más información.
...
Utilice la pestaña Servicio de ID de Experience Cloud para ver las solicitudes del [servicio de Experience Cloud ID](https://experiencecloud.adobe.com/resources/help/en_US/mcvid/).
