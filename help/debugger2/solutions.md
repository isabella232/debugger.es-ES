...
La pantalla del SDK web de AEP muestra información sobre el SDK web de la plataforma Adobe Experience. Haga clic en **[!UICONTROL Configure]** para activar o desactivar el inicio de sesión en la consola.
...
Utilice la sección Iniciar para ver las solicitudes de inicio. También puede hacer clic **[!UICONTROL Configuration]** para configurar los códigos [](https://docs.adobe.com/content/help/en/launch/using/reference/upgrade/link-dtm-embed-code.html)incrustados. Puede editar, reemplazar o agregar más códigos incrustados desde Depurador.

## Dynamic Tag Management {#dynamic-tag-management}

Utilice la sección Administración dinámica de etiquetas para ver las solicitudes de DTM. También puede hacer clic **[!UICONTROL Configuration]** para configurar los códigos [](https://docs.adobe.com/content/help/en/dtm/using/client-side/code.html)incrustados.
