...
Los números en azul junto a las fichas en la parte superior de la ventana muestran el número de llamadas al servidor que se han realizado. Puede restablecer estos valores a cero haciendo clic en **[!UICONTROL Clear All Requests]** dentro de la ficha correspondiente.
